...
BASE_TEMPLATE_URL=https://raw.githubusercontent.com/BeetleJooce/Moodle/$CURRENT_BRANCH/nested/
echo "Base template URL: $BASE_TEMPLATE_URL"

SCRIPT_LOCATION=https://raw.githubusercontent.com/BeetleJooce/Moodle/$CURRENT_BRANCH/scripts/
